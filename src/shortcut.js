(function( root, factory ){
	...
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["KeyShortcut"] = factory({});
	else
		root["KeyShortcut"] = factory({});
})(this, function( KeyShortcut ){
    ...
    KeyShortcut.config = function( options ){
        var configurable = [ 'DEBUG', 'repeat', 'timeout' ], k;
        for( k in options ){
    ...
    KeyShortcut.listenKeyDown = function( e, element ){
        ...
        if (cur_key in keyAlias) {
            cur_key = keyAlias[cur_key];
        }
